...
function onJSON(json){
  ...
  email_exists = json.exists;
      ...
      async function validazioneReg(event){
          ...
          if(inEmailR.value == ""){
            ...
            await fetch("http://localhost/esercizi/hw1/check_email.php?email="+email).then(onResponse).then(onJSON); 
